...
const ScanIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 7V5a2 2 0 0 1 2-2h2"/><path d="M17 3h2a2 2 0 0 1 2 2v2"/><path d="M21 17v2a2 2 0 0 1-2 2h-2"/><path d="M7 21H5a2 2 0 0 1-2-2v-2"/></svg>
);

// Icon for Health Rate
const HeartIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 14c1.49-1.28 3.6-2.34 4.63-2.75 1.39-.55 2.37-1.93 2.37-3.41 0-2.35-1.91-4.25-4.25-4.25-1.74 0-3.23 1.05-3.87 2.56-.51-1.07-1.3-1.98-2.28-2.67M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>
);
...
export default function HomePage() {
  ...
  const scanValue = isStatsLoading ? <LoadingSpinner size={24} /> : totalScans.toLocaleString();
  const healthValue = isStatsLoading ? <LoadingSpinner size={24} /> : healthRate;
  
  return (
    <div className={`relative min-h-screen ${bgColor} ${textColor} overflow-x-hidden selection:bg-indigo-500/30 transition-colors duration-300`}>
      
      <header className={`fixed inset-x-0 top-0 z-50 backdrop-blur-md ${bgColor} border-b ${theme === "dark" ? "border-white/5" : "border-slate-200"}`}>
        <Navbar />
      </header>
